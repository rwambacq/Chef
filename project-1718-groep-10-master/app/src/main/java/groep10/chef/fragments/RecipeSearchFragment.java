...
public class RecipeSearchFragment extends Fragment{
    ...
    public void onCreate(Bundle savedInstancestate) {
        ...
        if(args!=null && args.containsKey("filtered_recipes")){
            recipes = (List<Recipe>) args.getSerializable("filtered_recipes");
        }
        else if(args!=null && args.containsKey("recipes")){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parentVG,
        ...
        recipes = sorter(recipes);
        adapter = new RecipeAdapter(recipes, main, this.getContext(),false,null);
        list.setAdapter(adapter);
        return v;
    }

    public List<Recipe> sorter(List<Recipe> lijst){
